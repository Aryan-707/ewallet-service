...
import com.github.aryanaggarwal.dto.mapper.TransactionRequestMapper;
import com.github.aryanaggarwal.dto.mapper.TransactionResponseMapper;
...
import com.github.aryanaggarwal.domain.entity.LedgerEntry;
...
class TransactionServiceTest {
    ...
    void create_shouldCreateNewTransaction() {
        ...
        verify(ledgerEntryRepository, times(2)).save(any(com.github.aryanaggarwal.domain.entity.LedgerEntry.class));
    }
    ...
    void create_shouldRollbackAndSetFailedWhenCreditFails() {
        ...
        assertEquals(com.github.aryanaggarwal.domain.enums.Status.FAILED, transaction.getStatus());
    }
    ...
    void create_shouldSucceedAfterTransientCreditFailure_RetrySuccessTest() {
        ...
        assertEquals(com.github.aryanaggarwal.domain.enums.Status.COMPLETED, transaction.getStatus());
