package com.github.aryanaggarwal.controller;

import com.github.aryanaggarwal.dto.response.TransactionResponse;
import com.github.aryanaggarwal.service.TransactionService;
...
public class TransactionController {
    ...
    @PreAuthorize("hasRole(T(com.github.aryanaggarwal.domain.enums.RoleType).ROLE_USER)")
    @GetMapping("/{id}")
