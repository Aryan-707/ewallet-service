...
public class WalletService {
    ...
    public CommandResponse transferFunds(TransactionRequest request) {
        if (request.getIdempotencyKey() != null) {
            com.ewallet.domain.entity.Transaction existing = transactionService.findEntityByIdempotencyKey(request.getIdempotencyKey());
            if (existing != null) {
